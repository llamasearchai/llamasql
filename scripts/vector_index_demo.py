...
def main():
    ...
    parser.add_argument("--num-vectors", type=int, default=100000, help="Number of vectors to create")
    parser.add_argument("--dimension", type=int, default=128, help="Dimension of vectors")
    parser.add_argument("--k", type=int, default=10, help="Number of results to return in search")
