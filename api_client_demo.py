...
class LlamaDBClient:
    ...
    def search(self, 
        ...
        if len(vector) != target_dim:
            console.print(f"[yellow]Warning: Vector dimension ({len(vector)}) doesn't match index dimension ({target_dim})[/yellow]")
            ...
            if len(vector) < target_dim:
                ...
                vector = padded
                console.print(f"[green]Padded vector to {target_dim} dimensions[/green]")
            else:
                # Truncate
                vector = vector[:target_dim]
                console.print(f"[yellow]Truncated vector to {target_dim} dimensions[/yellow]")
...
def demo_api_client():
    ...
    if index_info:
        ...
        console.print(f"Vector index has {item_count} items with dimension {dimension}.")
    else:
    ...
    if results:
        ...
        console.print("[yellow]Note: If filtering doesn't work, the API may not support the filter_fn parameter yet[/yellow]")
