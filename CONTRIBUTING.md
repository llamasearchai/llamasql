# Contributing to LlamaSql

Thank you for your interest in contributing to LlamaSql! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaSql:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamasql.git
   cd llamasql
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamasql.git
   ```
...
By contributing to LlamaSql, you agree that your contributions will be licensed under the project's MIT License.
